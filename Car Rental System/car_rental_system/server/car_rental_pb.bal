...
public isolated client class CarRentalServiceClient {
    *grpc:AbstractClientEndpoint;
    ...
    isolated remote function list_reservations(Empty|ContextEmpty req) returns stream<Reservation, grpc:Error?>|grpc:Error {
        map<string|string[]> headers = {};
        Empty message;
        ...
        var payload = check self.grpcClient->executeServerStreaming("car_rental.CarRentalService/list_reservations", message, headers);
    ...
    isolated remote function list_reservationsContext(Empty|ContextEmpty req) returns ContextReservationStream|grpc:Error {
        map<string|string[]> headers = {};
        Empty message;
        if req is ContextEmpty {
            message = req.content;
